...
function Payment() {
  ...
  return (
    ...
    <div className="cardnum">
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"/>
        <p><input type="ccnumber" id="ccnum" name="cardnumberss" placeholder="1111-2222-3333-4444" /><i id="visalogo" class="fa fa-cc-visa"></i></p>
   ...
   <footer class="payment-site-footer">
                    <h1>About Greyson</h1>
