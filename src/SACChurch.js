 ...
 return (
  ...
  <form onSubmit={handleAccount}>
   ...
   <div class="Videogameadjust">
    <div className="nonp">
        <h1>St Antoninus Catholic Church</h1>
        <p1>337 S Orange Ave, Newark, NJ 07103</p1>
        <p3>(973) 623-0258</p3>
        <p><a className="com1link"href="http://www.saintantoninuschurch.org/">SAC-C!</a></p>
    </div>
    
    <img className="gmflogo"src="http://newarkstreets.com/photos/albums/userpics/10001/0337southorangeavenue.jpg" />
